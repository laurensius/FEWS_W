<div class="container">
    ...
    <script>
        $.ajax({
            ...
            success : function(response){
                ...
                if(response.length > 0){
                    ...
                    $('#param_nama_toko').html('<input id="nama_toko" class="form-control" type="text" name="p_nama_toko" value="' + response[0].nama_toko + '" required>');
                    $('#param_alamat_toko').html('<input id="alamat_toko" class="form-control" type="text" name="p_alamat_toko" value="' + response[0].alamat_toko + '" required>');
        ...
        function update(){
            ...
            $.ajax({
                url : '<?php echo site_url("/api/pengguna_update") . "/" . $this->uri->segment(3) . "/"; ?>'  ,
                type : 'POST',
                dataType : 'json',
                data: post,
                success : function(response){
